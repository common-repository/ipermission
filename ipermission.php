...
Plugin URI: https://hardani.de/ipermission/
...
function ipermission_admin_notices(){
	...
	if(!$widgets){	
		echo sprintf('<div class="updated"><p>%s</p></div>', 'Thank you for using our plugin, Please click <a href="'.get_admin_url().'index.php"/><strong>Here</strong> to complete the installation.</a>	</br><h3 class="update-nag"> Please visit our own <a href="http://hardani.de/ipermission/" target="_blank">support team</a> for any issues.</h3>
...
?>
	...
	</br><h3 class="update-nag"> Please visit our own <a href="http://hardani.de/ipermission" target="_blank">support team</a> for any issues.</h3>
